...
var hideAlert = function hideAlert() {
  ...
  if (el) el.parentElement.replaceChild(el);
};
...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password, name, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FueWNoODUiLCJhIjoiY2tuZWxqa3loMm1mZzJycDlsNXo5eHViNCJ9.a1YVnxdXYBcO5Uocpe9vHw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sanych85/cknvveen21ype17jg47ayr7o1',
    scrolZoom: false //   center: [ -118.11,34.111],
    //   zoom: 8,
    //   interactive:false
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost/api/v1/users/updateMypassword' : 'http://localhost/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(toorId) {
    var stripe, session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51J2E6TKn619xdMBGw1vG48dSKgornWGaB1wDe7sNAWy797d8kYfGRfWBiJ3JkYl0vrvG7zXr4FaOko2ewf4j4pCn00xJnXSLQ0');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("http://localhost:3000/api/v1/bookings/checkout-session/".concat(toorId));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--save-password').textContent = "Save password password";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12113" + '/');
